            ...
            >
              ...
              <div className="flex items-center gap-6 text-sm text-gray-600 mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  ${(subscription.items[0]?.unitPrice || subscription.items[0]?.price || 0).toFixed(2)}/mes
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="font-medium text-2xl">
                    ${(selectedSubscription.items[0]?.unitPrice || selectedSubscription.items[0]?.price || 0).toFixed(2)}
